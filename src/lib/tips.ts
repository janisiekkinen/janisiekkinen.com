...
export const tips: Tip[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Kuva sivusta, kepin tasolta. Näkyviin ote, kyynärpää ja valkoisen lähtö. Kymmenen sekuntia klippiä kohti riittää. Sitten voin sanoa, mitä muutetaan, eikä vain, miltä se “näyttää”.",
    ],
  },
  {
    locale: "en",
